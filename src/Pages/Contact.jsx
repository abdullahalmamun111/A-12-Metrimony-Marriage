...
const Contact = () => {
  return (
    <div className="bg-gray-100 mt-16 py-4 px-6 md:px-12 lg:px-20">
	  ...
	  <SectionTitle title={'Contact Us'} subtitle={" Were here to help! Feel free to reach out to us with any questions, feedback,or inquiries"}>
       </SectionTitle>
        ...
        <div className="bg-blue-50 rounded-lg shadow-lg p-8 lg:w-1/3">
          ...
          <ul className="space-y-4">
            ...
            <li>
              ...
              <a href="mailto:info@matrimonyhub.com" className="text-blue-600 hover:underline">
